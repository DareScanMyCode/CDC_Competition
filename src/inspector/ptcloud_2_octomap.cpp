...
static double map_resolution_1 = 2, map_resolution_2 = 0.5, map_resolution_3 = 0.1;
...
int main(int argc, char *argv[]) {
    ...
    ros::Subscriber sub_octomap_world = nh.subscribe("/world/octomap/" + uav_name, 1, world_octomap_callback);  // added zbw
    ros::Subscriber sub_inoccupied = nh.subscribe("/world/is_occupied", 1, is_occupied_callback);//给世界坐标判断是否被占据，消息类型用nav_msgs::Odometry


    ros::Publisher _octomap3D_all_pub   = nh.advertise<octomap_msgs::Octomap>("/world/octomap/" + uav_name, 1);
